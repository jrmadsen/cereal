...
concept Allocator {
    ...
    // \param originalSize The current size in bytes. (Design issue: since some allocator
may not book-keep this, explicitly pass to it can save memory.)
...
{
public:
    static const bool kNeedFree = false;  //!< Tell users that no need to call Free() with
                                          //!< this allocator. (concept Allocator)
    ...
    */
    ...
    /*! The user buffer will be used firstly. When it is full, memory pool allocates new
       ...
       kDefaultChunkSize. \param baseAllocator The allocator for allocating memory chunks.
    */
...
private:
    ...
    */
    ...
    {
        size_t
                     capacity;  //!< Capacity of the chunk in bytes (excluding the header itself).
