...
{
inline void
PrintInvalidKeyword(const char* keyword)
{
    printf("Fail keyword: %s\n", keyword);
}

inline void
PrintInvalidKeyword(const wchar_t* keyword)
{
    wprintf(L"Fail keyword: %ls\n", keyword);
}

inline void
PrintInvalidDocument(const char* document)
{
    printf("Fail document: %s\n\n", document);
}

inline void
PrintInvalidDocument(const wchar_t* document)
{
    wprintf(L"Fail document: %ls\n\n", document);
}

inline void
PrintValidatorPointers(unsigned depth, const char* s, const char* d)
{
    printf("S: %*s%s\nD: %*s%s\n\n", depth * 4, " ", s, depth * 4, " ", d);
}

inline void
PrintValidatorPointers(unsigned depth, const wchar_t* s, const wchar_t* d)
{
...
#define CEREAL_RAPIDJSON_STRING_(name, ...)                                              \
    ...
    CEREAL_RAPIDJSON_STRING_(Dependencies, 'd', 'e', 'p', 'e', 'n', 'd', 'e', 'n', 'c',
                             'i', 'e', 's')
    CEREAL_RAPIDJSON_STRING_(PatternProperties, 'p', 'a', 't', 't', 'e', 'r', 'n', 'P',
                             'r', 'o', 'p', 'e', 'r', 't', 'i', 'e', 's')
    CEREAL_RAPIDJSON_STRING_(AdditionalProperties, 'a', 'd', 'd', 'i', 't', 'i', 'o', 'n',
                             'a', 'l', 'P', 'r', 'o', 'p', 'e', 'r', 't', 'i', 'e', 's')
    CEREAL_RAPIDJSON_STRING_(MinProperties, 'm', 'i', 'n', 'P', 'r', 'o', 'p', 'e', 'r',
                             't', 'i', 'e', 's')
    CEREAL_RAPIDJSON_STRING_(MaxProperties, 'm', 'a', 'x', 'P', 'r', 'o', 'p', 'e', 'r',
                             't', 'i', 'e', 's')
    ...
    CEREAL_RAPIDJSON_STRING_(AdditionalItems, 'a', 'd', 'd', 'i', 't', 'i', 'o', 'n', 'a',
                             'l', 'I', 't', 'e', 'm', 's')
    CEREAL_RAPIDJSON_STRING_(UniqueItems, 'u', 'n', 'i', 'q', 'u', 'e', 'I', 't', 'e',
                             'm', 's')
    ...
    CEREAL_RAPIDJSON_STRING_(ExclusiveMinimum, 'e', 'x', 'c', 'l', 'u', 's', 'i', 'v',
                             'e', 'M', 'i', 'n', 'i', 'm', 'u', 'm')
    CEREAL_RAPIDJSON_STRING_(ExclusiveMaximum, 'e', 'x', 'c', 'l', 'u', 's', 'i', 'v',
                             'e', 'M', 'a', 'x', 'i', 'm', 'u', 'm')
...
struct TokenHelper
{
    CEREAL_RAPIDJSON_FORCEINLINE static void AppendIndexToken(Stack&   documentStack,
                                                              SizeType index)
    {
...
/*!
   ...
   construction). \tparam ValueT Type of JSON value (e.g. \c Value ), which also determine
   the encoding. \tparam Allocator Allocator type for allocating memory of this document.
*/
...
#define CEREAL_RAPIDJSON_STRING_(name, ...)                                              \
    ...
    {                                                                                    \
        static const Ch            s[] = { __VA_ARGS__, '\0' };                          \
        static const StringRefType v(s,                                                  \
                                     static_cast<SizeType>(sizeof(s) / sizeof(Ch) - 1)); \
        return v;                                                                        \
    }

    CEREAL_RAPIDJSON_STRING_(InstanceRef, 'i', 'n', 's', 't', 'a', 'n', 'c', 'e', 'R',
                             'e', 'f')
...
private:
    ...
    GenericSchemaValidator(const SchemaDocumentType& schemaDocument,
                           const SchemaType& root, const char* basePath,
                           size_t basePathSize,
#if CEREAL_RAPIDJSON_SCHEMA_VERBOSE
                           unsigned depth,
#endif
        ...
        else
        {
            if(CurrentContext().inArray)
                internal::TokenHelper<internal::Stack<StateAllocator>, Ch>::
                    AppendIndexToken(documentStack_, CurrentContext().arrayElementIndex);
                        ...
                        const typename SchemaType::ValueType& (*exclusive)() = 0)
    {
        ...
        currentError_.AddMember(GetExpectedString(),
                                ...
                                GetStateAllocator());
        if(exclusive)
            currentError_.AddMember(ValueType(exclusive(), GetStateAllocator()).Move(),
