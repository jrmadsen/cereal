...
enum WriteFlag
{
    ...
    kWriteDefaultFlags =
        CEREAL_RAPIDJSON_WRITE_DEFAULT_FLAGS  //!< Default write flags. Can be customized
                                              //!< by defining
...
public:
    ...
    */
    ...
    /*!
       ...
       significand for positive exponent) writer.Double(1.23e-4);                 // "0.0"
       (do truncate significand for negative exponent) writer.EndArray(); \endcode

        The default setting does not truncate any decimal places. You can restore to this
       setting by calling \code
    ...
    */
    ...
    {
        (void) memberCount;
        CEREAL_RAPIDJSON_ASSERT(level_stack_.GetSize() >=
                                sizeof(Level));  // not inside an Object
        CEREAL_RAPIDJSON_ASSERT(!level_stack_.template Top<Level>()
    ...
    /*!
       ...
       [0, length - 1] range. \param length Length of the json. \param type Type of the
       root of json.
    */
...
template <>
inline bool
Writer<StringBuffer>::WriteInt(int i)
{
...
template <>
inline bool
Writer<StringBuffer>::WriteUint(unsigned u)
{
...
template <>
inline bool
Writer<StringBuffer>::WriteInt64(int64_t i64)
{
...
template <>
inline bool
Writer<StringBuffer>::WriteUint64(uint64_t u)
{
...
template <>
inline bool
Writer<StringBuffer>::WriteDouble(double d)
{
    if(internal::Double(d).IsNanOrInf())
    {
